  ...
  return (
    <div className="flex min-h-dvh items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        <h1 className="font-mono text-7xl font-bold text-gradient-neon">404</h1>
  ...
  head: () => ({
    meta: [
      ...
      { title: "Alex Doe — Full Stack Developer" },
      {
        name: "description",
        content:
          "Portfolio of Alex Doe — Full Stack Developer building performant web, mobile, and backend systems.",
      },
